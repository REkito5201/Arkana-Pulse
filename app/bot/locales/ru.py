...
RU = {
    ...
    # /legend
    "legend.menu_title": "📚 Выбери индикатор, чтобы посмотреть краткое определение:",
    "legend.btn_rsi": "RSI",
    ...
    "Полосы вокруг средней цены. Верхняя и нижняя границы помогают видеть статистически высокие и низкие значения цены.",
    "legend.macd": "📊 *MACD*\n\n"
    "Разница между двумя экспоненциальными средними и её сглаживание. Линии и гистограмма показывают силу тренда "
    "и возможный разворот.",
    "legend.ichimoku": "📊 *Ichimoku Cloud*\n\n"
    "Комплексный индикатор тренда. Облако Span A/B задаёт зоны поддержки/сопротивления, а линии Tenkan/Kijun "
    "отображают баланс цены.",
    "legend.fear_greed": "📊 *Fear & Greed Index*\n\n"
    "Индекс настроений рынка от 0 (страх) до 100 (жадность). Экстремальные значения часто совпадают с разворотами.",
    # /lang
    "cmd_lang.current": "🌐 Язык: *{current}*. Выбери другой:",
